...
//   // Center the map to show all pharmacies and user location
//   const focusMapOnAllPoints = () => {
//     if (!mapRef.current || !location) return;
    
//     const points = [
//       { latitude: location.latitude, longitude: location.longitude },
//       ...PREDEFINED_PHARMACIES.map(pharmacy => ({
...
//   // Effect to focus map when location is available
//   useEffect(() => {
//     if (location) {
//       setTimeout(() => {
//         focusMapOnAllPoints();
...
//     // Animate map to focus on selected pharmacy
...
//                   name="local-pharmacy" 
//                   size={30} 
//                   color={selectedPharmacy && selectedPharmacy.place_id === pharmacy.place_id ? "#FF6347" : "#4CAF50"} 
//                 />
//               </Marker>
//             ))}
//           </MapView>
...
// //   const [selectedPharmacy, setSelectedPharmacy] = useState(null);
// //   const [loading, setLoading] = useState(false);
// //   const radiusKm = 5; // Fixed radius in km
// //   const mapRef = useRef(null);
...
// //         // Fetch pharmacies automatically using current location
// //         fetchNearbyPharmacies(currentLocation.coords.latitude, currentLocation.coords.longitude);
...
// //     // Center the map on the selected pharmacy
// //     mapRef.current?.animateToRegion({
// //       latitude: pharmacy.geometry.location.lat,
// //       longitude: pharmacy.geometry.location.lng,
// //       latitudeDelta: 0.01,
...
// //   // Function to return to user location
...
// //                   'Waiting for your location and pharmacy selection.');
// //       return;
// //     }
...
// //             : loading ? 'Searching for pharmacies...' : 'No pharmacies found'}
// //         </Text>
